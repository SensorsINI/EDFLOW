...
#
# restore.tcl: Tcl script for re-creating project '7z100All'
#
# Generated by Vivado on Tue Jan 11 20:39:51 +0100 2022
...
set orig_proj_dir "[file normalize "$origin_dir/7z100All"]"
...
set files [list \
 [file normalize "${origin_dir}/srcs/sources_1/imports/new/LEDShifter.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/new/SPI_Master.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/new/SPI_Master_With_Single_CS.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/new/USBFifoToDVSSPI.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/new/dataSwitch.v" ]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/ulpi_wrapper/rtl/ulpi_wrapper.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usb_desc_rom.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usbf_crc16.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usbf_defs.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usbf_device_core.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usbf_sie_rx.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usbf_sie_tx.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/imports/usbIP/usb_cdc/usb_cdc_core.v"]\
 [file normalize "${origin_dir}/srcs/sources_1/bd/brd/hdl/brd_wrapper.vhd"]\
]
...
set file "[file normalize ${origin_dir}/srcs/constrs_1/new/io.xdc]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/srcs/constrs_1/new/debug.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
...
set_property -name "top" -value "usb_cdc_core" -objects $obj
...
if { [get_files LEDShifter.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/new/LEDShifter.v
}
if { [get_files SPI_Master.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/new/SPI_Master.v
}
if { [get_files SPI_Master_With_Single_CS.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/new/SPI_Master_With_Single_CS.v
}
if { [get_files USBFifoToDVSSPI.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/new/USBFifoToDVSSPI.v
}
if { [get_files dataSwitch.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/new/dataSwitch.v
}
if { [get_files ulpi_wrapper.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/ulpi_wrapper/rtl/ulpi_wrapper.v
}
if { [get_files usb_desc_rom.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usb_desc_rom.v
}
if { [get_files usbf_crc16.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usbf_crc16.v
}
if { [get_files usbf_defs.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usbf_defs.v
}
if { [get_files usbf_device_core.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usbf_device_core.v
}
if { [get_files usbf_sie_rx.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usbf_sie_rx.v
}
if { [get_files usbf_sie_tx.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usbf_sie_tx.v
}
if { [get_files usb_cdc_core.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/sources_1/imports/usbIP/usb_cdc/usb_cdc_core.v
}
...
# module references:
# LEDShifter, SPI_Master_With_Single_CS, USBFifoToDVSSPI, dataSwitch, ulpi_wrapper, usb_cdc_core
  ...
  xilinx.com:user:testAERDVSSM:1.0\
  ...
  # Create instance: testAERDVSSM_1, and set properties
  set testAERDVSSM_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:testAERDVSSM:1.0 testAERDVSSM_1 ]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net DVSAERData_AI_0_1 [get_bd_ports DVSAERData_AI_0] [get_bd_pins testAERDVSSM_1/DVSAERData_AI]
  connect_bd_net -net DVSAERReq_ABI_0_1 [get_bd_ports DVSAERReq_ABI_0] [get_bd_pins testAERDVSSM_1/DVSAERReq_ABI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net IMUInterrupt_AI_0_1 [get_bd_ports IMUInterrupt_AI_0] [get_bd_pins testAERDVSSM_1/IMUInterrupt_AI]
  connect_bd_net -net LEDShifter_0_led [get_bd_ports led_0] [get_bd_pins LEDShifter_0/led]
  connect_bd_net -net Net [get_bd_ports IMUData_DZIO_0] [get_bd_pins testAERDVSSM_1/IMUData_DZIO]
  ...
  connect_bd_net -net SPI_Master_With_Sing_0_o_SPI_CS_n [get_bd_pins SPI_Master_With_Sing_0/o_SPI_CS_n] [get_bd_pins testAERDVSSM_1/SPISlaveSelect_ABI]
  connect_bd_net -net SPI_Master_With_Sing_0_o_SPI_Clk [get_bd_pins SPI_Master_With_Sing_0/o_SPI_Clk] [get_bd_pins testAERDVSSM_1/SPIClock_AI]
  connect_bd_net -net SPI_Master_With_Sing_0_o_SPI_MOSI [get_bd_pins SPI_Master_With_Sing_0/o_SPI_MOSI] [get_bd_pins testAERDVSSM_1/SPIMOSI_AI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net SyncInClock_AI_0_1 [get_bd_ports SyncInClock_AI_0] [get_bd_pins testAERDVSSM_1/SyncInClock_AI]
  connect_bd_net -net SyncInSignal1_AI_0_1 [get_bd_ports SyncInSignal1_AI_0] [get_bd_pins testAERDVSSM_1/SyncInSignal1_AI]
  connect_bd_net -net SyncInSignal2_AI_0_1 [get_bd_ports SyncInSignal2_AI_0] [get_bd_pins testAERDVSSM_1/SyncInSignal2_AI]
  connect_bd_net -net SyncInSignal_AI_0_1 [get_bd_ports SyncInSignal_AI_0] [get_bd_pins testAERDVSSM_1/SyncInSignal_AI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net fifo_generator_0_prog_full [get_bd_pins testAERDVSSM_1/AERSMFifoAlmostFull_AI] [get_bd_pins testAERDVSSM_1/AERSMFifoFull_AI] [get_bd_pins util_vector_logic_4/Res]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net testAERDVSSM_1_AERSMOutFifoData_DO [get_bd_pins EVMUXDataToXYTSStream_0/eventFIFOIn_V] [get_bd_pins testAERDVSSM_1/AERSMOutFifoData_DO]
  connect_bd_net -net testAERDVSSM_1_AERSMOutFifoWrite_SO [get_bd_pins EVMUXDataToXYTSStream_0/eventFIFODataValid_V] [get_bd_pins testAERDVSSM_1/AERSMOutFifoWrite_SO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasAddrSelect_SBO [get_bd_ports ChipBiasAddrSelect_SBO_0] [get_bd_pins testAERDVSSM_1/ChipBiasAddrSelect_SBO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasBitIn_DO [get_bd_ports ChipBiasBitIn_DO_0] [get_bd_pins testAERDVSSM_1/ChipBiasBitIn_DO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasClock_CBO [get_bd_ports ChipBiasClock_CBO_0] [get_bd_pins testAERDVSSM_1/ChipBiasClock_CBO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasDiagSelect_SO [get_bd_ports ChipBiasDiagSelect_SO_0] [get_bd_pins testAERDVSSM_1/ChipBiasDiagSelect_SO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasEnable_SO [get_bd_ports ChipBiasEnable_SO_0] [get_bd_pins testAERDVSSM_1/ChipBiasEnable_SO]
  connect_bd_net -net testAERDVSSM_1_ChipBiasLatch_SBO [get_bd_ports ChipBiasLatch_SBO_0] [get_bd_pins testAERDVSSM_1/ChipBiasLatch_SBO]
  connect_bd_net -net testAERDVSSM_1_DVSAERAck_SBO [get_bd_ports DVSAERAck_SBO_0] [get_bd_pins testAERDVSSM_1/DVSAERAck_SBO]
  connect_bd_net -net testAERDVSSM_1_DVSAERReset_SBO [get_bd_ports DVSAERReset_SBO_0] [get_bd_pins testAERDVSSM_1/DVSAERReset_SBO]
  connect_bd_net -net testAERDVSSM_1_IMUClock_CZO [get_bd_ports IMUClock_CZO_0] [get_bd_pins testAERDVSSM_1/IMUClock_CZO]
  connect_bd_net -net testAERDVSSM_1_IMUFSync_SO [get_bd_ports IMUFSync_SO_0] [get_bd_pins testAERDVSSM_1/IMUFSync_SO]
  connect_bd_net -net testAERDVSSM_1_SPIMISO_DZO [get_bd_pins SPI_Master_With_Sing_0/i_SPI_MISO] [get_bd_pins testAERDVSSM_1/SPIMISO_DZO]
  connect_bd_net -net testAERDVSSM_1_SyncOutClock_CO [get_bd_ports SyncOutClock_CO_0] [get_bd_pins testAERDVSSM_1/SyncOutClock_CO]
  connect_bd_net -net testAERDVSSM_1_SyncOutSignal_SO [get_bd_ports SyncOutSignal_SO_0] [get_bd_pins testAERDVSSM_1/SyncOutSignal_SO]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins USBFifoToDVSSPI_0/rst_i] [get_bd_pins testAERDVSSM_1/Reset_RI] [get_bd_pins util_vector_logic_0/Res]
