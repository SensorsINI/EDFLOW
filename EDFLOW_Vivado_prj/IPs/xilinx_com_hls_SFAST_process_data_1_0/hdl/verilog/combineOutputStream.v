...
module combineOutputStream (
        ...
        custDataStreamOut_V_s_TDATA,
        custDataStreamOut_V_s_TVALID,
        p_read,
        p_read1,
        glStatus_cornerEvent,
        glStatus_cornerEvent_ap_vld,
        glStatus_outEventsNu,
        glStatus_outEventsNu_ap_vld,
        glStatus_currentThre,
        glStatus_currentThre_ap_vld,
        packetEventDataStrea_blk_n,
        stageCornerStream_V_s_blk_n,
        xStreamOut_V_V_TDATA_blk_n,
        yStreamOut_V_V_TDATA_blk_n,
        polStreamOut_V_V_TDATA_blk_n,
        tsStreamOut_V_V_TDATA_blk_n,
        custDataStreamOut_V_s_TDATA_blk_n
);
...
output  [15:0] custDataStreamOut_V_s_TDATA;
output   custDataStreamOut_V_s_TVALID;
input  [31:0] p_read;
input  [7:0] p_read1;
output  [63:0] glStatus_cornerEvent;
output   glStatus_cornerEvent_ap_vld;
output  [63:0] glStatus_outEventsNu;
output   glStatus_outEventsNu_ap_vld;
output  [7:0] glStatus_currentThre;
output   glStatus_currentThre_ap_vld;
output   packetEventDataStrea_blk_n;
output   stageCornerStream_V_s_blk_n;
output   xStreamOut_V_V_TDATA_blk_n;
output   yStreamOut_V_V_TDATA_blk_n;
output   polStreamOut_V_V_TDATA_blk_n;
output   tsStreamOut_V_V_TDATA_blk_n;
output   custDataStreamOut_V_s_TDATA_blk_n;
...
reg glStatus_cornerEvent_ap_vld;
reg glStatus_outEventsNu_ap_vld;
reg glStatus_currentThre_ap_vld;
...
reg custDataStreamOut_V_s_TDATA_blk_n;
...
reg   [0:0] tmp_V_reg_313;
reg    ap_predicate_op31_write_state2;
reg    ap_block_state2_io;
reg    ap_block_state3_pp0_stage0_iter2;
reg   [0:0] tmp_175_reg_323_pp0_iter1_reg;
reg   [0:0] tmp_V_reg_313_pp0_iter1_reg;
...
reg   [15:0] custDataStreamOut_V_s_1_data_in;
reg   [15:0] custDataStreamOut_V_s_1_data_out;
reg    custDataStreamOut_V_s_1_vld_in;
wire    custDataStreamOut_V_s_1_vld_out;
wire    custDataStreamOut_V_s_1_ack_out;
reg   [15:0] custDataStreamOut_V_s_1_payload_A;
reg   [15:0] custDataStreamOut_V_s_1_payload_B;
reg    custDataStreamOut_V_s_1_sel_rd;
reg    custDataStreamOut_V_s_1_sel_wr;
wire    custDataStreamOut_V_s_1_sel;
wire    custDataStreamOut_V_s_1_load_A;
wire    custDataStreamOut_V_s_1_load_B;
reg   [1:0] custDataStreamOut_V_s_1_state;
wire    custDataStreamOut_V_s_1_state_cmp_full;
reg   [63:0] outEventsNum;
reg   [63:0] cornerEventsNum;
reg   [15:0] y_V_reg_292;
wire   [15:0] x_V_fu_174_p1;
reg   [15:0] x_V_reg_297;
reg   [0:0] pol_V_reg_302;
reg   [62:0] p_Result_i_reg_308;
wire   [0:0] tmp_V_read_fu_114_p2;
wire   [0:0] retData_V_fu_200_p2;
reg   [0:0] retData_V_reg_317;
wire   [63:0] tmp_50_i_fu_218_p2;
wire   [63:0] p_Result_s_fu_236_p5;
wire   [7:0] tmp_V_36_cast_fu_248_p1;
wire   [15:0] tmp_V_40_cast_fu_252_p1;
wire   [7:0] tmp_V_45_cast_fu_256_p1;
wire   [15:0] tmp_V_47_cast_fu_260_p1;
reg    ap_block_pp0_stage0_subdone;
wire   [63:0] ap_phi_reg_pp0_iter0_cornerEventsNum_loc_s_reg_155;
reg   [63:0] ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_155;
wire   [63:0] tmp_51_i_fu_274_p2;
...
#0 custDataStreamOut_V_s_1_sel_rd = 1'b0;
#0 custDataStreamOut_V_s_1_sel_wr = 1'b0;
#0 custDataStreamOut_V_s_1_state = 2'd0;
#0 outEventsNum = 64'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        custDataStreamOut_V_s_1_sel_rd <= 1'b0;
    end else begin
        if (((custDataStreamOut_V_s_1_ack_out == 1'b1) & (custDataStreamOut_V_s_1_vld_out == 1'b1))) begin
            custDataStreamOut_V_s_1_sel_rd <= ~custDataStreamOut_V_s_1_sel_rd;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        custDataStreamOut_V_s_1_sel_wr <= 1'b0;
    end else begin
        if (((custDataStreamOut_V_s_1_ack_in == 1'b1) & (custDataStreamOut_V_s_1_vld_in == 1'b1))) begin
            custDataStreamOut_V_s_1_sel_wr <= ~custDataStreamOut_V_s_1_sel_wr;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        custDataStreamOut_V_s_1_state <= 2'd0;
    end else begin
        if ((((custDataStreamOut_V_s_1_vld_in == 1'b0) & (custDataStreamOut_V_s_1_state == 2'd2)) | ((custDataStreamOut_V_s_1_vld_in == 1'b0) & (custDataStreamOut_V_s_1_ack_out == 1'b1) & (custDataStreamOut_V_s_1_state == 2'd3)))) begin
            custDataStreamOut_V_s_1_state <= 2'd2;
        end else if ((((custDataStreamOut_V_s_1_ack_out == 1'b0) & (custDataStreamOut_V_s_1_state == 2'd1)) | ((custDataStreamOut_V_s_1_ack_out == 1'b0) & (custDataStreamOut_V_s_1_vld_in == 1'b1) & (custDataStreamOut_V_s_1_state == 2'd3)))) begin
            custDataStreamOut_V_s_1_state <= 2'd1;
        end else if (((~((custDataStreamOut_V_s_1_vld_in == 1'b0) & (custDataStreamOut_V_s_1_ack_out == 1'b1)) & ~((custDataStreamOut_V_s_1_ack_out == 1'b0) & (custDataStreamOut_V_s_1_vld_in == 1'b1)) & (custDataStreamOut_V_s_1_state == 2'd3)) | ((custDataStreamOut_V_s_1_ack_out == 1'b1) & (custDataStreamOut_V_s_1_state == 2'd1)) | ((custDataStreamOut_V_s_1_vld_in == 1'b1) & (custDataStreamOut_V_s_1_state == 2'd2)))) begin
            custDataStreamOut_V_s_1_state <= 2'd3;
        end else begin
            custDataStreamOut_V_s_1_state <= 2'd2;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_150)) begin
        if ((tmp_V_read_fu_114_p2 == 1'd0)) begin
            ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_155 <= cornerEventsNum;
        end else if ((tmp_V_read_fu_114_p2 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_V_read_fu_114_p2 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        cornerEventsNum <= tmp_50_i_fu_218_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((custDataStreamOut_V_s_1_load_A == 1'b1)) begin
        custDataStreamOut_V_s_1_payload_A <= custDataStreamOut_V_s_1_data_in;
    end
end

always @ (posedge ap_clk) begin
    if ((custDataStreamOut_V_s_1_load_B == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_Result_i_reg_308 <= {{packetEventDataStrea_dout[95:33]}};
        pol_V_reg_302 <= packetEventDataStrea_dout[32'd32];
        retData_V_reg_317 <= retData_V_fu_200_p2;
        tmp_175_reg_323 <= p_read[32'd1];
        ...
        y_V_reg_292 <= {{packetEventDataStrea_dout[31:16]}};
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((ap_predicate_op31_write_state2 == 1'b1)) begin
            custDataStreamOut_V_s_1_data_in = tmp_V_47_cast_fu_260_p1;
        end else if ((tmp_175_reg_323 == 1'd0)) begin
            custDataStreamOut_V_s_1_data_in = tmp_V_40_cast_fu_252_p1;
        end else begin
            custDataStreamOut_V_s_1_data_in = 'bx;
        end
    end else begin
        custDataStreamOut_V_s_1_data_in = 'bx;
    end
...
always @ (*) begin
    if ((custDataStreamOut_V_s_1_sel == 1'b1)) begin
...
always @ (*) begin
    if ((((ap_predicate_op31_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_175_reg_323 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        custDataStreamOut_V_s_1_vld_in = 1'b1;
    end else begin
        custDataStreamOut_V_s_1_vld_in = 1'b0;
    end
end

always @ (*) begin
    if ((((ap_predicate_op55_write_state3 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op31_write_state2 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_175_reg_323 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        custDataStreamOut_V_s_TDATA_blk_n = custDataStreamOut_V_s_1_state[1'd1];
    end else begin
        custDataStreamOut_V_s_TDATA_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        glStatus_cornerEvent_ap_vld = 1'b1;
    end else begin
        glStatus_cornerEvent_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        glStatus_currentThre_ap_vld = 1'b1;
    end else begin
        glStatus_currentThre_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        glStatus_outEventsNu_ap_vld = 1'b1;
    end else begin
        glStatus_outEventsNu_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_start == 1'b1) & ((ap_start == 1'b0) | (stageCornerStream_V_s_empty_n == 1'b0) | (packetEventDataStrea_empty_n == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((custDataStreamOut_V_s_1_ack_in == 1'b0) | (tsStreamOut_V_V_1_ack_in == 1'b0) | (polStreamOut_V_V_1_ack_in == 1'b0) | (yStreamOut_V_V_1_ack_in == 1'b0) | (xStreamOut_V_V_1_ack_in == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_start == 1'b1) & ((ap_start == 1'b0) | (stageCornerStream_V_s_empty_n == 1'b0) | (packetEventDataStrea_empty_n == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (custDataStreamOut_V_s_1_ack_in == 1'b0) | (tsStreamOut_V_V_1_ack_in == 1'b0) | (polStreamOut_V_V_1_ack_in == 1'b0) | (yStreamOut_V_V_1_ack_in == 1'b0) | (xStreamOut_V_V_1_ack_in == 1'b0))) | ((1'b1 == ap_block_state2_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_start == 1'b1) & ((ap_start == 1'b0) | (stageCornerStream_V_s_empty_n == 1'b0) | (packetEventDataStrea_empty_n == 1'b0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (custDataStreamOut_V_s_1_ack_in == 1'b0) | (tsStreamOut_V_V_1_ack_in == 1'b0) | (polStreamOut_V_V_1_ack_in == 1'b0) | (yStreamOut_V_V_1_ack_in == 1'b0) | (xStreamOut_V_V_1_ack_in == 1'b0))) | ((1'b1 == ap_block_state2_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start == 1'b0) | (stageCornerStream_V_s_empty_n == 1'b0) | (packetEventDataStrea_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_io = (((ap_predicate_op31_write_state2 == 1'b1) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323 == 1'd0) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((tmp_175_reg_323 == 1'd0) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323 == 1'd0) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323 == 1'd0) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (xStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323 == 1'd0) & (xStreamOut_V_V_1_ack_in == 1'b0)));
end

assign ap_block_state2_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = (((ap_predicate_op55_write_state3 == 1'b1) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((ap_predicate_op55_write_state3 == 1'b1) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op55_write_state3 == 1'b1) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op55_write_state3 == 1'b1) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op55_write_state3 == 1'b1) & (xStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_175_reg_323_pp0_iter1_reg == 1'd0) & (xStreamOut_V_V_1_ack_in == 1'b0)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((custDataStreamOut_V_s_1_ack_in == 1'b0) | (tsStreamOut_V_V_1_ack_in == 1'b0) | (polStreamOut_V_V_1_ack_in == 1'b0) | (yStreamOut_V_V_1_ack_in == 1'b0) | (xStreamOut_V_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_condition_529 = ((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_phi_reg_pp0_iter0_cornerEventsNum_loc_s_reg_155 = 'bx;

always @ (*) begin
    ap_predicate_op31_write_state2 = ((tmp_V_reg_313 == 1'd1) & (tmp_175_reg_323 == 1'd1));
end

always @ (*) begin
    ap_predicate_op55_write_state3 = ((tmp_V_reg_313_pp0_iter1_reg == 1'd1) & (tmp_175_reg_323_pp0_iter1_reg == 1'd1));
end

assign custDataStreamOut_V_s_1_ack_in = custDataStreamOut_V_s_1_state[1'd1];

assign custDataStreamOut_V_s_1_ack_out = custDataStreamOut_V_s_TREADY;

assign custDataStreamOut_V_s_1_load_A = (~custDataStreamOut_V_s_1_sel_wr & custDataStreamOut_V_s_1_state_cmp_full);

assign custDataStreamOut_V_s_1_load_B = (custDataStreamOut_V_s_1_state_cmp_full & custDataStreamOut_V_s_1_sel_wr);

assign custDataStreamOut_V_s_1_sel = custDataStreamOut_V_s_1_sel_rd;

assign custDataStreamOut_V_s_1_state_cmp_full = ((custDataStreamOut_V_s_1_state != 2'd1) ? 1'b1 : 1'b0);

assign custDataStreamOut_V_s_1_vld_out = custDataStreamOut_V_s_1_state[1'd0];

assign custDataStreamOut_V_s_TDATA = custDataStreamOut_V_s_1_data_out;

assign custDataStreamOut_V_s_TVALID = custDataStreamOut_V_s_1_state[1'd0];

assign glStatus_cornerEvent = ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_155;

assign glStatus_currentThre = p_read1;

assign glStatus_outEventsNu = (outEventsNum + 64'd2);

assign p_Result_s_fu_236_p5 = {{ap_const_lv64_0[63:63]}, {p_Result_i_reg_308}};
...
assign retData_V_fu_200_p2 = (tmp_fu_196_p1 | stageCornerStream_V_s_dout);

assign tmp_50_i_fu_218_p2 = (cornerEventsNum + 64'd1);

assign tmp_51_i_fu_274_p2 = (outEventsNum + 64'd2);

assign tmp_V_36_cast_fu_248_p1 = pol_V_reg_302;

assign tmp_V_40_cast_fu_252_p1 = retData_V_reg_317;

assign tmp_V_45_cast_fu_256_p1 = pol_V_reg_302;

assign tmp_V_47_cast_fu_260_p1 = retData_V_reg_317;

assign tmp_V_read_fu_114_p2 = stageCornerStream_V_s_dout;

assign tmp_fu_196_p1 = p_read[0:0];
...
assign x_V_fu_174_p1 = packetEventDataStrea_dout[15:0];
