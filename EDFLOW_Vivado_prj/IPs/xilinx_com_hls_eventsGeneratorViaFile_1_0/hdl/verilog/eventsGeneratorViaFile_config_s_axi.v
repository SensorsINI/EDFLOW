...
`timescale 1ns/1ps
module eventsGeneratorViaFile_config_s_axi
#(parameter
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INPUT_V_CTRL: begin
                    rdata[0] <= int_input_V_ap_vld;
                end
            endcase
        end
    end
...
assign input_V_ap_vld = int_input_V_ap_vld;
// int_input_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_input_V[31:0] <= 0;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_input_V_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_INPUT_V_CTRL && WSTRB[0] && WDATA[0])
            int_input_V_ap_vld <= 1'b1;
        else
            int_input_V_ap_vld <= 1'b0; // self clear
    end
end
