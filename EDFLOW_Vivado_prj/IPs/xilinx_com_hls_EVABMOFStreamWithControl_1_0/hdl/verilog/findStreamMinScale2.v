...
wire   [14:0] tmp_V_173_fu_148_p3;
reg   [14:0] tmp_V_173_reg_234;
reg   [2:0] p_Repl2_46_reg_92;
reg    ap_block_state3;
wire   [5:0] tmpVal_V_fu_185_p3;
reg   [5:0] tmp_V_fu_62;
wire   [5:0] p_Result_22_fu_162_p3;
wire   [15:0] tmp_1073_cast_fu_134_p1;
wire   [14:0] tmp_2533_fu_144_p1;
...
initial begin
#0 ap_CS_fsm = 3'd1;
#0 currentMinScale2_V = 15'd32767;
end
...
assign compCond_V_fu_138_p2 = (($signed(inStream_V_dout) < $signed(tmp_1073_cast_fu_134_p1)) ? 1'b1 : 1'b0);

assign exitcond_fu_108_p2 = ((p_Repl2_46_reg_92 == 3'd7) ? 1'b1 : 1'b0);

assign i_fu_114_p2 = (p_Repl2_46_reg_92 + 3'd1);

assign minStream_V_V_din = tmp_V_173_reg_234;

assign p_Result_22_fu_162_p3 = {{tmpOF_y_V_fu_120_p1}, {p_Repl2_46_reg_92}};
...
assign tmp_1073_cast_fu_134_p1 = currentMinScale2_V;

assign tmp_2533_fu_144_p1 = inStream_V_dout[14:0];

assign tmp_V_173_fu_148_p3 = ((compCond_V_fu_138_p2[0:0] === 1'b1) ? tmp_2533_fu_144_p1 : currentMinScale2_V);

assign tmp_s_fu_124_p2 = ((p_Repl2_46_reg_92 == 3'd6) ? 1'b1 : 1'b0);

endmodule //findStreamMinScale2
