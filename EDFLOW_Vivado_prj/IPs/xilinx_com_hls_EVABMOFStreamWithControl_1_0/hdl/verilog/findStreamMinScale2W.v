...
reg    ap_block_state1;
wire    grp_findStreamMinScale2_fu_42_ap_start;
wire    grp_findStreamMinScale2_fu_42_ap_done;
wire    grp_findStreamMinScale2_fu_42_ap_idle;
wire    grp_findStreamMinScale2_fu_42_ap_ready;
wire    grp_findStreamMinScale2_fu_42_inStream_V_read;
wire    grp_findStreamMinScale2_fu_42_OF_yStream_V_read;
wire   [14:0] grp_findStreamMinScale2_fu_42_minStream_V_V_din;
wire    grp_findStreamMinScale2_fu_42_minStream_V_V_write;
wire   [5:0] grp_findStreamMinScale2_fu_42_OFStream_V_V_din;
wire    grp_findStreamMinScale2_fu_42_OFStream_V_V_write;
reg    grp_findStreamMinScale2_fu_42_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_findStreamMinScale2_fu_42_ap_start_reg = 1'b0;
end

findStreamMinScale2 grp_findStreamMinScale2_fu_42(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_findStreamMinScale2_fu_42_ap_start_reg <= 1'b0;
    end else begin
        if ((~((ap_start == 1'b0) | (select_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (select_V_read_read_fu_36_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_findStreamMinScale2_fu_42_ap_start_reg <= 1'b1;
        end else if ((grp_findStreamMinScale2_fu_42_ap_ready == 1'b1)) begin
            grp_findStreamMinScale2_fu_42_ap_start_reg <= 1'b0;
        end
    end
end
...
assign OFStream_V_V_din = grp_findStreamMinScale2_fu_42_OFStream_V_V_din;
...
always @ (*) begin
    ap_block_state2_on_subcall_done = ((select_V_read_reg_56 == 1'd1) & (grp_findStreamMinScale2_fu_42_ap_done == 1'b0));
end

assign grp_findStreamMinScale2_fu_42_ap_start = grp_findStreamMinScale2_fu_42_ap_start_reg;

assign minStream_V_V_din = grp_findStreamMinScale2_fu_42_minStream_V_V_din;

assign select_V_read_read_fu_36_p2 = select_V_dout;

endmodule //findStreamMinScale2W
