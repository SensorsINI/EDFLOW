...
module SPI_Master_With_Single_CS
  ...
  (
   ...
   output [7:0] o_RX_Byte,   // Byte received on MISO
    ...
    output [2:0] r_RX_Bit_Count_do,
    output [2:0] r_TX_Bit_Count_do,  
  ...
  SPI_Master 
   ...
   .o_RX_Byte(o_RX_Byte),   // Byte received on MISO
    ...
    .r_RX_Bit_Count(r_RX_Bit_Count_do),
    .r_TX_Bit_Count(r_TX_Bit_Count_do),
  ...
  assign w_Master_Ready_do = w_Master_Ready;
