...
entity findStreamMinScale0W is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of findStreamMinScale0W is 
    ...
    signal grp_findStreamMinScale0_fu_42_ap_start : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_ap_done : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_ap_idle : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_ap_ready : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_inStream_V_read : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_OF_yStream_V_read : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_minStream_V_V_din : STD_LOGIC_VECTOR (14 downto 0);
    signal grp_findStreamMinScale0_fu_42_minStream_V_V_write : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_OFStream_V_V_din : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_findStreamMinScale0_fu_42_OFStream_V_V_write : STD_LOGIC;
    signal grp_findStreamMinScale0_fu_42_ap_start_reg : STD_LOGIC := '0';
    ...
    component findStreamMinScale0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_findStreamMinScale0_fu_42 : component findStreamMinScale0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_findStreamMinScale0_fu_42_ap_start,
        ap_done => grp_findStreamMinScale0_fu_42_ap_done,
        ap_idle => grp_findStreamMinScale0_fu_42_ap_idle,
        ap_ready => grp_findStreamMinScale0_fu_42_ap_ready,
        inStream_V_dout => inStream_V_dout,
        inStream_V_empty_n => inStream_V_empty_n,
        inStream_V_read => grp_findStreamMinScale0_fu_42_inStream_V_read,
        OF_yStream_V_dout => OF_yStream_V_dout,
        OF_yStream_V_empty_n => OF_yStream_V_empty_n,
        OF_yStream_V_read => grp_findStreamMinScale0_fu_42_OF_yStream_V_read,
        minStream_V_V_din => grp_findStreamMinScale0_fu_42_minStream_V_V_din,
        minStream_V_V_full_n => minStream_V_V_full_n,
        minStream_V_V_write => grp_findStreamMinScale0_fu_42_minStream_V_V_write,
        OFStream_V_V_din => grp_findStreamMinScale0_fu_42_OFStream_V_V_din,
        OFStream_V_V_full_n => OFStream_V_V_full_n,
        OFStream_V_V_write => grp_findStreamMinScale0_fu_42_OFStream_V_V_write);
    ...
    grp_findStreamMinScale0_fu_42_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_findStreamMinScale0_fu_42_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (select_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (select_V_read_read_fu_36_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_findStreamMinScale0_fu_42_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_findStreamMinScale0_fu_42_ap_ready = ap_const_logic_1)) then 
                    grp_findStreamMinScale0_fu_42_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    OFStream_V_V_write_assign_proc : process(select_V_read_reg_56, grp_findStreamMinScale0_fu_42_OFStream_V_V_write, ap_CS_fsm_state2)
    begin
    ...
    OF_yStream_V_read_assign_proc : process(select_V_read_reg_56, grp_findStreamMinScale0_fu_42_OF_yStream_V_read, ap_CS_fsm_state2)
    begin
        if (((select_V_read_reg_56 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            OF_yStream_V_read <= grp_findStreamMinScale0_fu_42_OF_yStream_V_read;
        else 
    ...
    ap_block_state2_on_subcall_done_assign_proc : process(select_V_read_reg_56, grp_findStreamMinScale0_fu_42_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((select_V_read_reg_56 = ap_const_lv1_1) and (grp_findStreamMinScale0_fu_42_ap_done = ap_const_logic_0));
    end process;
    ...
    grp_findStreamMinScale0_fu_42_ap_start <= grp_findStreamMinScale0_fu_42_ap_start_reg;

    inStream_V_read_assign_proc : process(select_V_read_reg_56, grp_findStreamMinScale0_fu_42_inStream_V_read, ap_CS_fsm_state2)
    begin
        if (((select_V_read_reg_56 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            inStream_V_read <= grp_findStreamMinScale0_fu_42_inStream_V_read;
        else 
    ...
    minStream_V_V_write_assign_proc : process(select_V_read_reg_56, grp_findStreamMinScale0_fu_42_minStream_V_V_write, ap_CS_fsm_state2)
    begin
        if (((select_V_read_reg_56 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            minStream_V_V_write <= grp_findStreamMinScale0_fu_42_minStream_V_V_write;
        else 
