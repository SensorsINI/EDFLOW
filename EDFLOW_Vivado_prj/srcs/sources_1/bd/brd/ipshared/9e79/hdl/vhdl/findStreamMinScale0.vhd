...
architecture behav of findStreamMinScale0 is 
    ...
    signal currentMin_V : STD_LOGIC_VECTOR (14 downto 0) := "111111111111111";
    ...
    signal tmp_V_177_fu_148_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_V_177_reg_234 : STD_LOGIC_VECTOR (14 downto 0);
    signal p_Repl2_48_reg_92 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal tmpVal_V_fu_185_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_V_fu_62 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_24_fu_162_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_1083_cast_fu_134_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_2539_fu_144_p1 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    currentMin_V_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((tmp_s_reg_225 = ap_const_lv1_1) and (ap_const_logic_0 = OFStream_V_V_full_n)) or ((tmp_s_reg_225 = ap_const_lv1_1) and (minStream_V_V_full_n = ap_const_logic_0)))) and (tmp_s_reg_225 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                currentMin_V <= ap_const_lv15_7FFF;
                ...
                currentMin_V <= tmp_V_177_fu_148_p3;
            end if; 
        end if;
    end process;

    p_Repl2_48_reg_92_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((tmp_s_reg_225 = ap_const_lv1_1) and (ap_const_logic_0 = OFStream_V_V_full_n)) or ((tmp_s_reg_225 = ap_const_lv1_1) and (minStream_V_V_full_n = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                p_Repl2_48_reg_92 <= i_reg_215;
            elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                p_Repl2_48_reg_92 <= ap_const_lv3_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((tmp_s_reg_225 = ap_const_lv1_1) and (ap_const_logic_0 = OFStream_V_V_full_n)) or ((tmp_s_reg_225 = ap_const_lv1_1) and (minStream_V_V_full_n = ap_const_logic_0)))) and (tmp_s_reg_225 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                ...
                tmp_V_fu_62 <= p_Result_24_fu_162_p3;
            elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((exitcond_fu_108_p2 = ap_const_lv1_0) and (ap_const_logic_0 = OF_yStream_V_empty_n)) or ((exitcond_fu_108_p2 = ap_const_lv1_0) and (inStream_V_empty_n = ap_const_logic_0)))) and (exitcond_fu_108_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                ...
                tmp_V_177_reg_234 <= tmp_V_177_fu_148_p3;
    ...
    compCond_V_fu_138_p2 <= "1" when (signed(inStream_V_dout) < signed(tmp_1083_cast_fu_134_p1)) else "0";
    exitcond_fu_108_p2 <= "1" when (p_Repl2_48_reg_92 = ap_const_lv3_7) else "0";
    i_fu_114_p2 <= std_logic_vector(unsigned(p_Repl2_48_reg_92) + unsigned(ap_const_lv3_1));
    ...
    minStream_V_V_din <= tmp_V_177_reg_234;
    ...
    p_Result_24_fu_162_p3 <= (tmpOF_y_V_fu_120_p1 & p_Repl2_48_reg_92);
    p_Result_s_fu_178_p3 <= (tmpOF_y_V_reg_220 & ap_const_lv3_6);
    tmpOF_y_V_fu_120_p1 <= OF_yStream_V_dout(3 - 1 downto 0);
    tmpVal_V_fu_185_p3 <= 
        p_Result_s_fu_178_p3 when (compCond_V_reg_229(0) = '1') else 
        tmp_V_fu_62;
    tmp_1083_cast_fu_134_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(currentMin_V),16));
    tmp_2539_fu_144_p1 <= inStream_V_dout(15 - 1 downto 0);
    tmp_V_177_fu_148_p3 <= 
        tmp_2539_fu_144_p1 when (compCond_V_fu_138_p2(0) = '1') else 
        currentMin_V;
    tmp_s_fu_124_p2 <= "1" when (p_Repl2_48_reg_92 = ap_const_lv3_6) else "0";
end behav;
